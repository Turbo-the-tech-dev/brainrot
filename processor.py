...
def calculate_ohio_risk(load):
    """
    Calculate risk based on neural load.
    Ensures input is numeric and within reasonable bounds (0-100).
    """
...
if __name__ == "__main__":
    ...
    # Write to telemetry.json to avoid overwriting legacy deadpan-brainrot.json
